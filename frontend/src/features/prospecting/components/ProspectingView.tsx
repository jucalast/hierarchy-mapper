...
const ProspectMap = dynamic(() => import('./ProspectMap'), {
  ssr: false,
  loading: () => (
    <div style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', color: 'var(--sw-text-muted)', gap: 8 }}>
  ...
  return (
    <div style={{ position: 'relative', width: 44, height: 44, flexShrink: 0 }}>
      ...
      <div style={{ position: 'absolute', inset: 0, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center' }}>
        ...
        <span style={{ fontSize: 8, color: 'var(--sw-text-muted)', marginTop: 1 }}>{tier}</span>
      </div>
    </div>
  );
}
  ...
  return (
    <div style={{
      ...
      <div style={{ display: 'flex', justifyContent: 'center', padding: '8px 0 2px' }}>
        <div style={{ width: 32, height: 3, borderRadius: 2, background: 'var(--sw-border)' }} />
      </div>
             ...
             {lead.logo_url && (
               <div style={{
                 position: 'absolute', bottom: -2, right: -2,
                  ...
                  border: '2px solid var(--sw-border)', background: 'var(--sw-bg)',
