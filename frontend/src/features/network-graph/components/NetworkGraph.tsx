                ...
                <div className={styles.mainWrapper}>
                    <header className={styles.globalHeader}>
                        ...
                        <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginLeft: 'auto' }}>
                            {/* Integration Stack - Active Integrations (Uses Human Analysis CSS patterns) */}
                            <div className={styles.humanAnalysisAvatarStack} title="Integrações Ativas" style={{ marginRight: '16px', pointerEvents: 'auto' }}>
                                {[
                                    { id: 'pipedrive', src: '/pipedrive.png' },
                                    { id: 'whatsapp', src: '/wppicon.png' },
                                    ...
                                    <div
                                        ...
                                        style={{ 
                                            background: integration.background || 'var(--sw-surface-raised)',
                                            cursor: 'pointer'
                                        }}
                                    >
                                        <img
