...
class HierarchyConfig(Base):
    ...
    forbidden_keywords = Column(SafeJSON) # Map of department -> list of words
    whitelist_keywords = Column(SafeJSON) # List of strings
    seniority_rules = Column(SafeJSON) # Map of keywords -> score
    department_mapping_rules = Column(SafeJSON) # Map of keywords -> tag
