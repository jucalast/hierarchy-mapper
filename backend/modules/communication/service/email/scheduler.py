...
from core.observability.logging_config import get_logger, set_request_id
...
async def check_inbox_async() -> None:
    ...
    try:
        from modules.triggers.service.trigger_service import is_quiet_hours, _service_paused
