...
def _build_task_action_prompt(act_id, subject: str, org: str, org_pd_id, deal_id, act_type: str, note: str) -> str:
    ...
    return (
        ...
        f"  4. Para ações externas (enviar mensagem, marcar concluído), apresente ao João e aguarde aprovação.\n"
        f"  5. Não marque a atividade #{act_id} como concluída a menos que seja o objetivo explícito da tarefa.\n\n"
