...
class CallPipeline(BasePipeline):
    ...
    def build_steps(cls, subject: str, act_id: Any, org_pd_id: Any, deal_id: Any) -> str:
        return (
            ...
            f"  1. pipedrive_get_persons → obter número de telefone REAL do CRM e a 'profile_pic' se disponível.\n"
            ...
            f"  2. prepare_live_coaching_session(contact_name, phone, profile_pic) → Prepara o plano de voo (passo a passo) para a ligação usando SPIN Selling. Passe a 'profile_pic' encontrada no passo 1.\n"
