"""
services.hierarchy.ai_helpers
==============================

Helpers de IA para o pipeline de hierarquia organizacional.
Usa o LLM Router (services.ai.llm) com fallback automático entre provedores.
"""
...
from services.ai.llm.base import NoProviderAvailableError
