...
async def _analyze_trigger(trigger: Dict, session) -> None:
    ...
    try:
        from services.ai.business_context import get_business_context_for_prompt
        from services.ai.prompts import INCOMING_RESPONSE_ANALYSIS_PROMPT
        from services.ai.llm import ask_llm
