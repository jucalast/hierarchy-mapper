...
async def main():
    try:
        ...
        while has_more:
            # Use correct Pipedrive endpoint for organization deals
            resp = await pipedrive_service._request("GET", f"organizations/1080/deals", params={"start": start, "limit": limit})
